          ...
          {user ? (
            <>
              <span className="text-2xl font-semibold">
                Welcome, <span className="font-semibold text-green-300">{capitalize(user.name)}</span>
              </span>

              <button
                onClick={handleLogout}
                className="bg-green-600 px-4 py-2 rounded-lg hover:bg-red-700 transition"
              >
                Logout
              </button>
            ...
            <>
              <button
                ...
                className="bg-green-600  font-semibold px-4 py-2 rounded-lg hover:bg-blue-700 transition"
              >
                Signup
              </button>
              <button
